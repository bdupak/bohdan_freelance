...
<link href="../resources/css/lib/select2.css" rel="stylesheet"
	type="text/css">
<link href="../resources/css/lib/awesome-bootstrap-checkbox.css"
	rel="stylesheet" type="text/css">
<link href="../resources/css/signup/signup.css" rel="stylesheet"
	type="text/css">
</head>
<body>
				...
				<div class="panel panel-primary animated fadeIn cabinet-top">
					...
					<div class="panel-body">
						...
						<form role="form" method="post" id="registerForm"
							...
							<div class="form-group">
								<div class="col-xs-1" data-tooltip="yes" title="Autodetect"
									data-placement="left">
							...
							<button type="submit" id="addMeBtn"
								class="btn btn-primary btn-block">Add me!</button>
